...
public class GlobalExceptionHandler{
    ...
    @ResponseBody
    public ReturnModel doError(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Exception ex) {
        ex.printStackTrace();
        ...
        return ReturnModel.create(responseData,"fail");
    }
}
